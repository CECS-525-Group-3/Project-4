//***************************************************
//
//	LCD.h - this file contains the defines
//	for using a standard LCD character module
//	including init, delay, printf, and putch.
//
...
#define STDIN  0		// this isn's used with printf, but is defined here for completeness.
#define STDOUT 1
#define STDERR 2
